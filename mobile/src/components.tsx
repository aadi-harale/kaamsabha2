...
const styles = StyleSheet.create({
  ...
  title: { marginTop: 2, fontSize: 22, color: colors.ink, fontWeight: "850" },
  ...
  pillText: { fontSize: 12, fontWeight: "750" },
  ...
  metricLabel: { color: colors.muted, fontSize: 12, fontWeight: "650" },
  ...
  sectionHeading: { color: colors.ink, fontSize: 18, fontWeight: "850" },
