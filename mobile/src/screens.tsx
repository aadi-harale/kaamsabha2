...
const styles = StyleSheet.create({
  ...
  roleTitle: { color: colors.ink, fontWeight: "800", fontSize: 15 },
  ...
  serviceName: { color: colors.ink, fontWeight: "800", fontSize: 14 },
  ...
  successText: { color: colors.success, fontWeight: "700", fontSize: 12, marginTop: 10 },
